...
class DestinationTableViewCell: UITableViewCell {
    ...
    lazy var statusLabel: Paddedlabel = {
        ...
        label.textInserts = UIEdgeInsets(top: 5, left: 10, bottom: 5, right: 10)
        return label
    }()
...
class Paddedlabel: UILabel {
    ...
    var textInserts = UIEdgeInsets.zero {
        didSet {
    ...
    override var intrinsicContentSize: CGSize {
        ...
        size.height += textInserts.top + textInserts.bottom
        size.width += textInserts.left + textInserts.right
        return size
    }
